--[[
Cảm Ơn Bạn Đã Sử Dụng Dịch Vụ , Chúc Bạn Có 1 Trải Nghiệm Vui Vẻ.
Nếu Có Lỗi Hoặc Cần Hỗ Trợ Hãy Liên Hệ Trên Nhé, Bạn Có Thể Pr Cho Bạn Bè Nữa Càng Tốt:D
Discord: https://discord.com/invite/XvTSUEXVng
]]--
...
local Window = OrionLib:MakeWindow({Name = "LongHub", HidePremium = false, IntroText = "LongGamingHQ Library", SaveConfig = true, ConfigFolder = "Long GamingHQ Hub"})
----------Tab-----------------------
...
elseif World3 then
	tableBoss = {"Long GamingHQ Raid Boss [Lv. 3000]","Stone","Island Empress","Kilo Admiral","Captain Elephant","Beautiful Pirate","rip_indra True Form","Longma","Soul Reaper","Cake Queen"}
end
        ...
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "Long Hub(Noitification)",
                    Content = "[EN] : Please cancel the farrm level quest (if any)",
                    Image = "rbxassetid://16107698496",
                    Time = 9
                })
                OrionLib:MakeNotification({
                    Name = "Long Hub(Noitification)",
